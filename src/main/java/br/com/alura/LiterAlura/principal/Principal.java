...
public class Principal {
    ...
    public Principal(RepositorioLivros repositorioLivros, ConsumoAPI consumoAPI, ConverterDados converteDados) {
    ...
    private void salvarLivros(List<Livro> livros) {
        livros.forEach(repositorioLivros::save);
    }
    ...
    private void buscarLivrosPeloTitulo() {
        ...
        try {
            ...
            JsonNode rootNode = converterDados.getObjectMapper().readTree(jsonResponse);
            ...
            List<LivroDTO> livrosDTO = converterDados.getObjectMapper()
                    .readerForListOf(LivroDTO.class)
                    .readValue(resultsNode);

            // Remove as duplicatas existentes no banco de dados
            List<Livro> livrosExistentes = RepositorioLivros.findByTitulo(titulo);
    ...
    private void listarAutoresVivos() {
        ...
        List<Autor> autores = RepositorioLivros.findAutoresVivos(year);
        if (autores.isEmpty()) {
    ...
    private void listarAutoresVivosRefinado() {
        ...
        List<Autor> autores = RepositorioLivros.findAutoresVivosRefinado(year);
        if (autores.isEmpty()) {
            System.out.println("Nenhum autor vivo encontrado.");
        } else {
    ...
    private void listarAutoresPorAnoDeMorte() {
        ...
        List<Autor> autores = RepositorioLivros.findAutoresPorAnoDeMorte(year);
        if (autores.isEmpty()) {
            System.out.println("Nenhum autor vivo encontrado.");
        } else {
    ...
    private void listarLivrosPorIdioma() {
        ...
        List<Livro> livros = RepositorioLivros.findByIdioma(idioma);
        if (livros.isEmpty()) {
